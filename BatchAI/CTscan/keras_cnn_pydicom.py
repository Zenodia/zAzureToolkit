...
if __name__=='__main__': 
    ...
    train_batch=train_datagen.flow(X_train, y_train, batch_size=2, seed=123, shuffle=True )
    test_batch=test_datagen.flow(X_test, y_test, batch_size=2, seed=123, shuffle=True )
