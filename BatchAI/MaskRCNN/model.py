...
class MaskRCNN():
    ...
    def __init__(self, mode, config, model_dir, save_model):
        """
        ...
        #self.model_save=save_model_path
        self.set_log_dir()
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers, save_model):
        """Train the model.
        ...
        self.keras_model.save_weights(save_model+"microscopy.h5")
